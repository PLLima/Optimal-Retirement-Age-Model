...
- setup_params.mlx       : Configuration file containing all model parameters.
...
- stationary_analysis.mlx: Validation script for zero-growth scenarios.
...
Step 2: Double-click 'run_analysis.mlx' to open it.
